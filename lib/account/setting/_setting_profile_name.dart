...
class SettingProfileNameWidget extends StatefulWidget {

  @override
  _SettingProfileNameState createState() => new _SettingProfileNameState();
}

class _SettingProfileNameState extends State<SettingProfileNameWidget> {
  ...
  void initState() {
    ...
    usernameController.text = Member.myName;
...
//                        padding: EdgeInsets.all(12),
  ...
  _update_myname() async {

    _onLoading();

    var _name = usernameController.text;
    var _update = await AuthService().updateName(_name);
